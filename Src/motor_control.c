...
static THD_FUNCTION(motor_control_thd, arg) //Works but not reliable at all. Need to find a way to get more stable value out of the sensors
{
	(void) arg;
	...
	//on rend le robot sourd jusqu'a la fin de la rotation
		...
		chThdSleepUntilWindowed(time, time + MS2ST(1)); //reduced the actualisation rate to 1kHz
	}
}
